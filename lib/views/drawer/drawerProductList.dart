...
class DrawerProductList extends StatefulWidget {
  @override
  _DrawerProductListState createState() => _DrawerProductListState();
}

class _DrawerProductListState extends State<DrawerProductList> {
